...
from httprunner.ext.har2all import init_har2all_parser, main_har2all
...
def main():
    ...
    sub_parser_har2all = init_har2all_parser(subparsers)
    ...
    elif sys.argv[1] == "har2all":
        # hrun har2all
        if len(sys.argv) == 2:
            sub_parser_har2all.print_help()
            sys.exit(0)
...
# def main_har2all():
#     """ command har2all
#         create api and testcases
#     """
#     sys.argv.insert(1, "har2all")
#     main()
